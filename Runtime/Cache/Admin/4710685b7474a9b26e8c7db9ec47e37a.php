...
<script>
    ...
    <div class="tab-wrap">
        ...
        <div class="tab-content">
            <!-- 表单 -->
            <form id="form" action="<?php echo U('company_edit');?>" method="post" class="form-horizontal">
                <!-- 基础文档模型 -->
                ...
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <input type="text" class="text input-large" name="companyname" value="<?php echo ($data['companyname']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">公司图片</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="picture" value="<?php echo ($data['picture']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">信用代码</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="creditcode" value="<?php echo ($data['creditcode']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                ...
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <input type="text" class="text input-large" name="site" value="<?php echo ($data['site']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">公司简介</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="companyprofile" value="<?php echo ($data['companyprofile']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">superstar</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="superstar" value="<?php echo ($data['superstar']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">jobinten</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="jobinten" value="<?php echo ($data['jobinten']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">pay</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="pay" value="<?php echo ($data['pay']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">jobtitle</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="jobtitle" value="<?php echo ($data['jobtitle']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">jobfield</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="jobfield" value="<?php echo ($data['jobfield']); ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">fulltime</label>
                    <div class="controls">
                        <input type="text" class="text input-large" name="fulltime" value="<?php echo ($data['fulltime']); ?>">
                    </div>
                </div>
                ...
                <div class="form-item cf">
                    ...
                    <?php if(C('OPEN_DRAFTBOX') and (ACTION_NAME == 'add' or $data['status'] == 3)): ?><button class="btn save-btn" url="<?php echo U('article/autoSave');?>" target-form="form-horizontal"id="autoSave">存草稿</button><?php endif; ?>
