    ...
    <div class="data-table">
        <table class="">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><span><?php echo ($vo['companyname']); ?></span></td>
                    <td><span><?php echo ($vo['creditcode']); ?></span></td>
                    <td><span><?php echo ($vo['name']); ?></span></td>
                    <td><span><?php echo ($vo['mobile']); ?></span></td>
                    <td><span><?php echo ($vo['site']); ?></span></td>
                    <td><span><?php echo ($vo['companyprofile']); ?></span></td>

                    <td><a href="<?php echo U('Article/company_edit?&id='.$vo['id']);?>">编辑</a>
