    ...
    <div class="data-table">
        <table class="">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><span><?php echo ($vo['picture']); ?></span></td>
                    <td><span><?php echo ($vo['name']); ?></span></td>
                    <td><span><?php echo ($vo['gender']); ?></span></td>
                    <td><span><?php echo ($vo['age']); ?></span></td>
                    <td><span><?php echo ($vo['education']); ?></span></td>
                    <td><span><?php echo ($vo['worktime']); ?></span></td>
                    <td><span><?php echo ($vo['region']); ?></span></td>
                    <td><span><?php echo ($vo['jobinten']); ?></span></td>
